...
class _MyJobsWidgetState extends State<MyJobsWidget> {
  ...
  FutureOr<String> barcodeScan() async {
    try {
  ...
  void initState() {
    super.initState();
    found = jobs;
    WidgetsBinding.instance.addPostFrameCallback((_) => getProjects()
        .then((value) => {
              super.setState(() {
                var val = value;
                val.forEach((element) {
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (BuildContext bc, int index) {
                            return Container(
                              child: ListTile(
                                onTap: () async {
                                  selProj = found.elementAt(index).jobId;
                                  await Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                ...
                                title: Text(
                                  '${found[index].client + " - " + found[index].jobId}',
                                  style: FlutterFlowTheme.of(context)
                                      .subtitle1
                                      .override(
                                        fontFamily: 'Poppins',
